...
/** 取引の事実のみ（収入・支出は非表示で、学習者が判断する） */
export interface CashBookTransactionFact {
  date: string
  description: string
  amount: number
}
...
export interface CashBookProblem {
  ...
  /** 取引の事実（日付・摘要・金額のみ。収入・支出は学習者が判断） */
  transactions: CashBookTransactionFact[]
  answer: CashBookRow[]
}
...
export const CASH_BOOK_PROBLEMS: CashBookProblem[] = [
  {
    ...
    transactions: [
      ...
      { date: '4/15', description: '売掛金回収', amount: 40000 },
      { date: '4/20', description: '給料支払', amount: 35000 }
    ],
    answer: [
  ...
  },
  {
    ...
    transactions: [
      { date: '5/1', description: '借入金', amount: 100000 },
      { date: '5/8', description: '備品購入', amount: 45000 },
      { date: '5/15', description: '売上', amount: 55000 },
      { date: '5/22', description: '借入金返済', amount: 50000 }
    ],
    answer: [
  ...
  },
  {
    ...
    transactions: [
      { date: '6/3', description: '売上', amount: 28000 },
      { date: '6/10', description: '仕入', amount: 60000 },
      { date: '6/18', description: '売掛金回収', amount: 90000 },
      { date: '6/25', description: '諸経費支払', amount: 15000 }
    ],
    answer: [
